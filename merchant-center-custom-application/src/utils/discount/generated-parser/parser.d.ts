...
export type StartRuleNames = 'predicate' | 'target_and_operator';
export interface ParseOptions<T extends StartRuleNames = 'predicate'> {
  /**
...
declare function ParseFunction<Options extends ParseOptions<'predicate'>>(
  input: string,
  options?: Options
): any;

declare function ParseFunction<
  Options extends ParseOptions<'target_and_operator'>
